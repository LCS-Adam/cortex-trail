...
CREATE OR REPLACE API INTEGRATION SFE_CORTEX_TRAIL_GIT_API
    ...
    API_ALLOWED_PREFIXES = ('https://github.com/LCS-Adam')
    ENABLED = TRUE
    COMMENT = 'cortex-trail - GitHub API integration for public repository access';
...
CREATE DATABASE IF NOT EXISTS SNOWFLAKE_EXAMPLE
    COMMENT = 'Repository for example projects ';
...
-- Connects to: https://github.com/LCS-Adam/cortex-trail
...
CREATE OR REPLACE GIT REPOSITORY SNOWFLAKE_EXAMPLE.GIT_REPOS.SFE_CORTEX_TRAIL_REPO
    ...
    ORIGIN = 'https://github.com/LCS-Adam/cortex-trail.git'
    COMMENT = 'cortex-trail - Cortex Cost Calculator toolkit public repository';
...
CREATE OR REPLACE STREAMLIT SNOWFLAKE_EXAMPLE.CORTEX_USAGE.CORTEX_COST_CALCULATOR
    ...
    COMMENT = 'cortex-trail - Interactive cost analysis and forecasting for Cortex services';
...
--    -> Verify repo is public: https://github.com/LCS-Adam/cortex-trail
